...
export function makeStudent(fields) {
  return Object.assign({
    ...
    ageStageLabel: '',
    // Regular home-lesson workdays for this learner. Additive/optional — older
    // saved students simply have no workdays field and callers treat a missing
    // day as "true" only via the setup helpers' defaults.
...
export const SETUP_STEPS = [
  ...
  { id: 'rhythm', label: 'Broad Rhythm & Loops', order: 3 },

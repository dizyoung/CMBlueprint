...
export function buildSampleAppState() {
  ...
  var subjectColumns = [
    M.makeSubjectColumn({ id: 'bible', label: 'Bible', color: '#d4537e', sortOrder: 0 }),
    M.makeSubjectColumn({ id: 'history', label: 'History', color: '#378add', sortOrder: 1 }),
    M.makeSubjectColumn({ id: 'literature', label: 'Literature', color: '#7f77dd', sortOrder: 2 }),
    M.makeSubjectColumn({ id: 'math', label: 'Math', color: '#555555', sortOrder: 3 }),
    M.makeSubjectColumn({ id: 'science', label: 'Science / Natural History', color: '#639922', sortOrder: 4 })
  ];
  ...
  var starterTemplates = [
    M.makeStarterTemplate({
      id: 'tpl_naturestudy', title: 'Nature Study', subjectColumnId: 'science',
      suggestedAudience: 'together', suggestedParticipantMode: 'together', suggestedScheduleMode: 'weekly',
      suggestedResourceExpectation: 'none', likelyPracticeNoBook: true,
      suggestedLessonTimeConfig: M.lessonTimeConfigFromGradeBand('form1'),
      ageStageApplicability: ['form1', 'form2', 'form3']
    }),
    M.makeStarterTemplate({
      id: 'tpl_picturestudy', title: 'Picture Study', subjectColumnId: 'literature',
      suggestedAudience: 'together', suggestedParticipantMode: 'together', suggestedScheduleMode: 'weekly',
      suggestedResourceExpectation: 'book', ageStageApplicability: ['form1', 'form2', 'form3']
    })
  ];

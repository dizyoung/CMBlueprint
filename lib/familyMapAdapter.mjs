...
export function buildSampleAppState() {
  ...
  var cards = [
    ...
    c({
      id: 'card_history_spine', title: 'History Spine', subjectColumnId: 'history',
      audience: 'group', participantMode: 'group', participantIds: ['older'], status: 'active',
      planningStatus: 'active', formApplicability: F23,
  ...
  var resources = [
    ...
    M.makeResource({ id: 'res_history_spine', title: 'History Spine (TBD)', type: 'book', status: 'need-to-choose' }),
